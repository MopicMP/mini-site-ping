...
> Mini monitor website uptime with alerts

[![PyPI version](https://badge.fury.io/py/mini-site-ping.svg)](https://pypi.org/project/mini-site-ping/)
...
```bash
pip install mini-site-ping
```

## Quick Start

```python
from mini_site_ping import ping
...
from mini_site_ping import batch
